...
import { PanResponder, Animated, View, StyleSheet, Dimensions, InteractionManager, I18nManager } from 'react-native'
  ...
  renderMain() {
    return (
      <Animated.View
        ...
        key="main"
        ref={c => this.main = c}
        style={[this.stylesheet.main, {backgroundColor: '#2ff'}, {height: this.getMainHeight(), transform:[ {scale: this.state.scale}], width: this.getMainWidth()}]}
      >
